...
public class NEWSMO01_Newbury_register_from_first_use_notice {
	//Initiate driver
	WebDriver driver;	
	...
	public void i_am_a_user_of_Axate_and_I_am_on_the_registration_page_through_Cricketer_FUN(String browser) throws Throwable {
		...
		if (browser.equalsIgnoreCase("chrome")) { 
			...
			popbitch_first_use_elements.Click_On_newbury_First_Use_CreateWallet();
	...
	public void navigated_to_the_same_article() throws Throwable {
	    ...
	    String expected_url = "https://www.newburytoday.co.uk/news/news/27964/no-quantitative-need-for-additional-convenience-stores-in-thatcham.html";
